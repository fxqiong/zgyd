var headData = {
  ...
  "keywordJson":[{"name":"包月流量包","href":"http://search.10086.cn/search?content=%E5%8C%85%E6%9C%88%E6%B5%81%E9%87%8F%E5%8C%85&areacode=sx","editable":"3","responsible":"1","isEdit":"2","highLight":"0"}],
  "hotWordsJson":[{"name":"国漫专区","href":"http://search.10086.cn//search?content=%E5%9B%BD%E6%BC%AB%E4%B8%93%E5%8C%BA&from=10101&start=1&field=&host=&pagesize=10&datetime=all&areacode=351","editable":"3","responsible":"0","isEdit":"0","highLight":"1"},{"name":"选号入网","href":"http://search.10086.cn//search?content=%E9%80%89%E5%8F%B7%E5%85%A5%E7%BD%91&from=10101&start=1&field=&host=&pagesize=10&datetime=all&areacode=351","editable":"3","responsible":"0","isEdit":"0","highLight":"0"},{"name":"宽带","href":"http://search.10086.cn//search?content=%E5%AE%BD%E5%B8%A6&start=1&field=&host=&pagesize=10&datetime=all&areacode=351","editable":"3","responsible":"0","isEdit":"0","highLight":"0"},{"name":"彩铃","href":"http://search.10086.cn//search?content=%E5%BD%A9%E9%93%83&start=1&field=&host=&pagesize=10&datetime=all&areacode=351","editable":"3","responsible":"0","isEdit":"0","highLight":"0"},{"name":"密码重置","href":"http://search.10086.cn//search?content=%E5%AF%86%E7%A0%81%E9%87%8D%E7%BD%AE&from=10101&start=1&field=&host=&pagesize=10&datetime=all&areacode=351","editable":"3","responsible":"0","isEdit":"0","highLight":"0"},{"name":"通话记录查询","href":"http://search.10086.cn//search?content=%E9%80%9A%E8%AF%9D%E8%AE%B0%E5%BD%95%E6%9F%A5%E8%AF%A2&from=10101&start=1&field=&host=&pagesize=10&datetime=all&areacode=351","editable":"3","responsible":"0","isEdit":"0","highLight":"0"}],
  "loginYYT":{"name":"登录","href":"https://sx.ac.10086.cn/login","editable":"1","responsible":"1","isEdit":"0","highLight":"0"},
  "loginOutYYT":{"name":"退出","href":"http://sx.ac.10086.cn/logout","editable":"1","responsible":"1","isEdit":"0","highLight":"0"},
};
...
$(document).ready(function(){
  ...
  //加载卷帘
  if((location.pathname.toLowerCase().indexOf("/sx") == 0 || location.pathname.toLowerCase().indexOf("/sample/indexsample") == 0) && ("0"=="1") && !judgeMT){
    autoAdd();
  }
  //搜索区域
...
function renderTopBar(pobj,cobj) {
  ...
  link.setAttribute("href","/sx_head/css/head.css");
  ...
  if ("sx" == "xz" || isJTSite(window.location.host)) { // 西藏按照集团网站方式，进行登录和退出
...
function renderMiddleArea(pobj,cobj){
  ...
  <li>\
  <button type=\"button\" class=\"close visible-xs-block\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\"><img src=\"/sx_head/images/phonedivcity.png\"></span></button>\
  <span>全部省份</span>\
  </li>\
  <li>\
  <dl class=\"clearfix\">\
...
function renderSearchBox(pobj,cobj){
  ...
  //var keywordJson =  eval('[{"name":"包月流量包","href":"http://search.10086.cn/search?content=%E5%8C%85%E6%9C%88%E6%B5%81%E9%87%8F%E5%8C%85&areacode=sx","editable":"3","responsible":"1","isEdit":"2","highLight":"0"}]');//可选框默认热门搜索词
  ...
  var aImgPhone = $("<img>");
  aImgPhone.attr("src","/sx_head/images/phonenav.png");
...
function chk_frm_search() {
  ...
  if(qt == searchKeyWord[0].name){
  	 ...
  	 url="http://search.10086.cn/search?content="+encodeURIComponent(qt)+"&areacode=sx";
  }
  window.open(url);
  return false;
}
